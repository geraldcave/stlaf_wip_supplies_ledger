...
if (!isset($_SESSION['user_id']) || strtolower($_SESSION['department']) !== 'marketing') {
...
if (strtolower($user['department']) !== 'marketing') {
    echo "Access denied. You are not in marketing.";
    exit();
}
...
<head>
    ...
    <title>STLAF | Marketing Dashboard</title>
