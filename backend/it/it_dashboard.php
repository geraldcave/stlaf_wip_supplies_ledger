...
if (!isset($_SESSION['user_id']) || strtolower($_SESSION['department']) !== 'it') {
...
if (strtolower($user['department']) !== 'it') {
    echo "Access denied. You are not in it.";
    exit();
}
...
<head>
    ...
    <title>STLAF | IT Dashboard</title>
