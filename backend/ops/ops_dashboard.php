...
if (!isset($_SESSION['user_id']) || strtolower($_SESSION['department']) !== 'ops') {
...
if (strtolower($user['department']) !== 'ops') {
    echo "Access denied. You are not in ops.";
    exit();
}
...
<head>
    ...
    <title>STLAF | Ops Dashboard</title>
