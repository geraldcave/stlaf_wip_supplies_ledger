...
if (!isset($_SESSION['user_id']) || strtolower($_SESSION['department']) !== 'corporate') {
...
if (strtolower($user['department']) !== 'corporate') {
    echo "Access denied. You are not in corporate.";
    exit();
}
...
<head>
    ...
    <title>STLAF | Corporate Dashboard</title>
